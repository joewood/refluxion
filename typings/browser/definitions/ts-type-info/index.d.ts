...
// Source: node_modules/ts-type-info/node_modules/code-block-writer/code-block-writer.d.ts
declare module '~ts-type-info~code-block-writer/code-block-writer' {
...
declare module '~ts-type-info~code-block-writer' {
export * from '~ts-type-info~code-block-writer/code-block-writer';
export { default } from '~ts-type-info~code-block-writer/code-block-writer';
}

// Generated by typings
// Source: node_modules/ts-type-info/ts-type-info.d.ts
declare module '~ts-type-info/ts-type-info' {
import CodeBlockWriter from '~ts-type-info~code-block-writer';
...
declare module 'ts-type-info/ts-type-info' {
export * from '~ts-type-info/ts-type-info';
}
