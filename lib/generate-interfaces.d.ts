...
export declare function generateWhereInterface(modelFile: TsTypeInfo.FileDefinition, modelRoot: TsTypeInfo.ClassDefinition, collectClass: TsTypeInfo.ClassDefinition): string;
